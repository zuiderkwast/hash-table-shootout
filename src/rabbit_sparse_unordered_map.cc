...
typedef rabbit::sparse_unordered_map<int64_t, int64_t, std::hash<int64_t>> hash_t;
typedef rabbit::sparse_unordered_map<std::string, int64_t, std::hash<std::string>> str_hash_t;
