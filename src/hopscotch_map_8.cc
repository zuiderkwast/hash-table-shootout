...
typedef hopscotch_map<int64_t, int64_t, std::hash<int64_t>, std::equal_to<int64_t>, uint8_t> hash_t;
typedef hopscotch_map<std::string, int64_t, std::hash<std::string>, std::equal_to<std::string>, uint8_t> str_hash_t;
